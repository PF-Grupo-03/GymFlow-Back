...
-- CreateEnum
CREATE TYPE "Musclues" AS ENUM ('PECHO', 'ESPALDA', 'BICEPS', 'TRICEPS', 'HOMBROS', 'CORE', 'CARDIO', 'BRAZOS_INFERIORES', 'BRAZOS_SUPERIORES', 'PIERNAS_INFERIORES', 'PIERNAS_SUPERIORES', 'CUELLO', 'CINTURA');
